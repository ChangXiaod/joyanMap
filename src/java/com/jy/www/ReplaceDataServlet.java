 ...
 */
@WebServlet(name = "ReplaceDataServlet", urlPatterns = {"/ReplaceDataServlet"})
public class ReplaceDataServlet extends HttpServlet {
...
//            if (info != null) {
            ...
            if (data_obj != null) {
                //将数据保存到数据库表中
                int num = sdd.replaceData(sid, data_obj);
                if (num > 0) {
                    //记录操作日志                    
//                    if (info_obj != null) {
