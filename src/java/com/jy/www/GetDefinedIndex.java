 ...
 * @author root
 */
@WebServlet(name = "GetDefinedIndex", urlPatterns = {"/GetDefinedIndex"})
public class GetDefinedIndex extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //将从前端获得数据转为json对象
            if (index_id != null) {
                String index_data = sdd.getDefinedIndex(Integer.valueOf(index_id));
                if (index_data != null) {
                    //查询指标数据成功
